...
function EmberApp() {
  ...
  var isProduction =  (this.env==='production' || this.env==='staging' );
...
EmberApp.prototype.contentFor = function(config, match, type) {
  ...
  content = this.project.addons.reduce(function(content, addon) {
    ...
    if (addonContent) {
      deprecateUI('The `' + type + '` hook used in ' + addon.name + ' is deprecated. The addon should generate a module and have consumers `require` it.', ~deprecatedHooks.indexOf(type));
